...
// ค่าย "กำลังดำเนินการ" = มีแถว Camp ล่าสุดที่ยังไม่กด "จบค่าย" (การสร้างค่ายบังคับกำหนดประธาน/เลขา/หัวหน้าฝ่ายครบอยู่แล้ว ดู createCamp)
...
function describeLockedReason(state) {
  if (!state.hasCamp) {
    return 'ยังไม่มีค่ายที่กำลังดำเนินการ ระบบจะเปิดใช้งานเมื่อ WebManager สร้างค่ายและกำหนดประธานค่าย รองประธาน เลขานุการ และหัวหน้าฝ่ายครบทุกฝ่ายแล้ว';
  }
