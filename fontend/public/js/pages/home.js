document.addEventListener('DOMContentLoaded', function () {
      ...
      trackData.forEach((track) => {
        ...
        card.innerHTML = `
          <div class="track-profile-wrapper flex justify-center">
            <img src="${track.imageUrl || '../../backend/uploads/presidents/profile.jpg'}" alt="image" class="track-profile-img">
          </div>
  ...
  function renderHeroCard(trackData) {
    ...
    if (image) image.src = latest.imageUrl || '../../backend/uploads/presidents/profile.jpg';
    ...
    if (uniLogo) {
      ...
      if (latest.universityLogoUrl) {
        uniLogo.src = latest.universityLogoUrl;
